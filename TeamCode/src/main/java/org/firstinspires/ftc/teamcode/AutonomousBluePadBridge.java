...
@Autonomous(name = "AutonomousBluePadBridge")
public class AutonomousBluePadBridge extends OpMode {
    final int FR = 0;
    final int FL = 1;
    final int BL = 2;
    final int BR = 3;
    ...
    public void loop() {
        switch (stage) {
            ...
            case 7:
                ...
                break;
            case 8:
                if (Motors[FL].getCurrentPosition() <= -1100) {
                    telemetry.addData("FL", Motors[FL].getCurrentPosition());
                    stage++;
                    stop();
                    resetEncoders();
            ...
            case 12:
                ...
                break;
            case 13:
                if (Motors[FL].getCurrentPosition() >= 150) {
                    stop();
                    telemetry.addData("FL", Motors[FL].getCurrentPosition());
                    stage++;
                } else {
            ...
            case 17:
                ...
                break;
            case 18:
                if (Motors[FL].getCurrentPosition() <= -750) {
                    stop();
                    telemetry.addData("FL", Motors[FL].getCurrentPosition());
                    resetEncoders();
                    stage++;
