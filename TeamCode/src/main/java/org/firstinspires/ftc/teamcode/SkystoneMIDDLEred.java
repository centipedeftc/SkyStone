 ...
 */
@Autonomous(name = "SkystoneMIDDLEred", group = "DogeCV")

public class SkystoneMIDDLEred extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while ((opModeIsActive())) {
            ...
            switch (stage) {
                ...
                case 5:
                    if (Motors[FL].getCurrentPosition() >= 250) {
                ...
                case 6:
                    if (Motors[FL].getCurrentPosition() >= 1950) {
                        telemetry.addData("FL", Motors[FL].getCurrentPosition());
                        MotorEnd();
                ...
                case 12:
                    ...
                    if (Motors[FL].getCurrentPosition() >= 2400) {
                        MotorEnd();
                        resetEncoders();
                        stage++;
                    } else {
                ...
                case 13:
                    ...
                    break;
                //turn to align with the block in center
                case 14:
                    if (Motors[FL].getCurrentPosition() >= 200) {
                        MotorEnd();
                        resetEncoders();
                ...
                //turn to align with the bridge
                case 18:
                    if (Motors[FL].getCurrentPosition() <= -1600) {
                        MotorEnd();
                        resetEncoders();
                        Servos[G].setPosition(1);
                        stage++;
