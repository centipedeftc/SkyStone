 ...
 */
@Autonomous(name = "SkystoneINred", group = "DogeCV")

public class SkystoneINred extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while ((opModeIsActive())) {
            ...
            switch (stage) {
                ...
                case 6:
                    if (Motors[FL].getCurrentPosition() >= 2050) {
                        telemetry.addData("FL", Motors[FL].getCurrentPosition());
                        MotorEnd();
                ...
                case 10:
                    if (Motors[FR].getCurrentPosition() >= 800) {
                        MotorEnd();
                        Servos[G].setPosition(0);
                        resetEncoders();
                        runtime.reset();
                ...
                case 12:
                    ...
                    if (Motors[FL].getCurrentPosition() >= 2500) {
                        MotorEnd();
                        resetEncoders();
                        stage++;
                    } else {
                ...
                case 13:
                    if (Motors[FL].getCurrentPosition() <= 10) {
                        telemetry.addData("FL", Motors[FL].getCurrentPosition());
                        MotorEnd();
                        resetEncoders();
                        runtime.reset();
                    ...
                    break;
                //turn to align with the block closest to the wall
                case 14:
                    if (Motors[FL].getCurrentPosition() >= 200) {
                        MotorEnd();
                        resetEncoders();
                ...
                case 17:
                    if (Motors[FL].getCurrentPosition() <= -90) {
                        telemetry.addData("FL", Motors[FL].getCurrentPosition());
                        MotorEnd();
                        resetEncoders();
                        runtime.reset();
                ...
                //turn to align with the bridge
                case 18:
                    if (Motors[FL].getCurrentPosition() <= -1700) {
                        MotorEnd();
                        resetEncoders();
                        Servos[G].setPosition(1);
                        stage++;
