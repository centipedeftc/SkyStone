 ...
 */
@Autonomous(name = "SkystoneTestBlue", group = "DogeCV")

public class SkystoneTestBlue extends LinearOpMode {
        ...
        while ((opModeIsActive())) {
            ...
            switch (stage) {
                case 0:
                    ...
                    break;
                case 1:
                    if (Motors[LMY].getCurrentPosition() <= -600) {
                    ...
                    break;
                case 2:
                    if (Motors[FL].getCurrentPosition() >= 175) {
                        MotorEnd();
                        runtime.reset();
                        stage++;
                    } else {
                    ...
                    break;
                //move forward to shake out collection and raise lift
                case 3:
                    ...
                    break;
                //move backwards to shake out lift and wall align
                case 4:
                    if (Motors[FL].getCurrentPosition() >= 500) {
                        MotorEnd();
                        resetEncoders();
                        stage++;
                    } else {
                    ...
                    //move forward towards the quarry
                    ...
                    break;
                //lower lift after collection went down
                case 5:
                    if (skyStoneDetector.getScreenPosition().x >= 20 && skyStoneDetector.getScreenPosition().x <= 80) {
                        MotorEnd();
                        resetEncoders();
                        stage++;
                    } else {
                        Motors[FR].setPower(-0.1);
                        Motors[FL].setPower(0.1);
                        Motors[BR].setPower(0.1);
                        Motors[BL].setPower(-0.1);
                    }
                    break;
                //Move sideways until the block is detected
                case 6:
                    if (runtime.milliseconds() < 2000) {
                        telemetry.addData("IT RANNNNNNNNNNNNNNNNNNNNN        11111111111111", null);
                    } else if (runtime.milliseconds() > 2000 && runtime.milliseconds() < 4000) {
                        telemetry.addData("IT RANNNNNNNNNNNNNNNNNNNNN        222222222222", null);
                    } else {
                        telemetry.addData("IT RANNNNNNNNNNNNNNNNNNNNN       3333333333333333333", null);
                        break;
                    }
            }
        }
